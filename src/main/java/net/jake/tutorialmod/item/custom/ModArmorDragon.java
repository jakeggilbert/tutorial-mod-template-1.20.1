package net.jake.tutorialmod.item.custom;

import com.google.common.collect.ImmutableMap;
import net.jake.tutorialmod.item.ModArmorMaterials;
...
public class ModArmorDragon extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.DRAGON,
                            new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, effectDuration, amplifier)).build();

    public ModArmorDragon(ArmorMaterial material, Type slot, Settings settings) {
